                            ...
                            <form method="post">
										<div class="form-group">
											...
											<select name="extra"class="form-control">
												...
												<option value="5dis">5% Discount</option>
												<option value="10dis">10% Discount</option>
												<option value="20dis">20% Discount</option>
											</select>
										 </div>
										<div class="form-group">
...
<?php
						...
						{	
								...
								else if($_POST['extra']=="10dis")
								{
									$extra = .10;
								}
								else if($_POST['extra']=="20dis")
								{
									$extra = .20;
								}
								else
							...
							if($st=="Conform")
							{
									$urb = "UPDATE `roombook` SET `stat`='$st',`extra`='$extra' WHERE id = '$id'";
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
													...
													$textra = $ttot * $extra;
														...
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`, `troom`, `discount`, `extra`,`token`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`meal`, `mepr`, `btot`,`fintot`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$troom','$discnt','$textra','$token','$bed','$nroom','$cin','$cout','$ttot','$meal','$mepr','$btot','$fintot','$days')";
